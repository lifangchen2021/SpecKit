...
| Na-23    | (n,γ)    | Na-24   | 14.958       | ENDF/B-VIII.1  | E720-16       |
...
<p>This dataset contains the MCNP-generated benchmark spectrum (ground truth), prior and unfolded spectra for the 60-, 113-, and 240-group cases, and the numerical data used to generate the tables and figures reported in the manuscript.</p>
